...
2. Install all the libraries mentioned in the [requirements.txt](https://github.com/JanushiShastri/Movie-Recommendation-System/blob/main/requirements.txt) file.
